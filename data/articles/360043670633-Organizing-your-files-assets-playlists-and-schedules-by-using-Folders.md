...
![OptiSigns Files/Assets page with the New Folder button highlighted at the top right](https://support.optisigns.com/hc/article_attachments/55276910294675)

To create a new folder for Playlists, click the "New Folder" button in the Playlists tab.

![OptiSigns Playlists page with the Add Folder icon button highlighted beside Create Playlist](https://support.optisigns.com/hc/article_attachments/55276910392595)

To create a new folder for Schedule, click the "New Folder' button in the Schedules tab.

![OptiSigns Schedules page with the Add Folder icon button highlighted beside Create Schedule](https://support.optisigns.com/hc/article_attachments/55276896456083)
