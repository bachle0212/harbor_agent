...
![URayCoder video encoder admin console, Main stream page, with the HLS URL row switched to Enable.](https://support.optisigns.com/hc/article_attachments/10158743969939)

Click Apply after the change, then you will be able to see the URL to use for the HLS stream from the status page.

![Encoder Status page listing the stream URLs, with the HLS URL http://192.168.1.168/0.m3u8 marked.](https://support.optisigns.com/hc/article_attachments/10158882063635)
...
![OptiSigns Video Stream app dialog, Name set to Live TV HLS Stream and the encoder HLS URL in URL.](https://support.optisigns.com/hc/article_attachments/55498111880467)
...
![A TV playing the Live TV stream in a split screen beside a social feed and a stock ticker.](https://support.optisigns.com/hc/article_attachments/10159027869971)
