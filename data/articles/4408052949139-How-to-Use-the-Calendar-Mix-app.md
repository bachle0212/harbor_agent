...
![image](https://support.optisigns.com/hc/article_attachments/4408420138515)
...
Go to Files/Assets, Click on "Apps" and add "Calendar Mix"

![OptiSigns portal with arrows on the Files/Assets tab and the Apps button](https://support.optisigns.com/hc/article_attachments/55247362245395)

![Add App dialog filtered to calendar apps, with Calendar Mix highlighted](https://support.optisigns.com/hc/article_attachments/55247391863955)

![Calendar Mix settings dialog showing Name, Add Source, Title and Display Mode](https://support.optisigns.com/hc/article_attachments/55247362250771)
...
![Calendar Mix Advanced options, from Only Show Ongoing and Upcoming Events through Language](https://support.optisigns.com/hc/article_attachments/55247391876627)
...
- Photo: Toggle this if you would like to display a photo with your Calendar. It will also activate a clock and current date to display as well.
  - Background Image: When Photo is selected, this is where you will choose the image.
- Text Color: text color of the display
- Font Size: font size of the display
- Start week on: (only available if you select Week as Display Mode) Enables you to choose either Monday or Sunday as start of week.
...
- Use Your Calendar Event Color: Lets you use the colors from your source calendar(s).
...
- Language: Choose the Language you wish to display your calendar in.

The app will also auto-adjust the format to a screen in portrait orientation (rotated screen):

![image](https://support.optisigns.com/hc/article_attachments/4408424940051)
