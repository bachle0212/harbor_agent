...
![Files/Assets left panel with the Apps button highlighted](https://support.optisigns.com/hc/article_attachments/54322345166995)

Select **Google Slides**:

![Add App search results showing the Google Slides app](https://support.optisigns.com/hc/article_attachments/54322307462547)

You'll see the following screen:

![The Google Slides dialog asking for the presentation URL](https://support.optisigns.com/hc/article_attachments/54322307463187)
...
![image](https://support.optisigns.com/hc/article_attachments/48704526167443)
...
![Name, URL, Update Interval and Auto-advance settings for a public presentation](https://support.optisigns.com/hc/article_attachments/54322345171731)
...
![image](https://support.optisigns.com/hc/article_attachments/48704526172563)

![image](https://support.optisigns.com/hc/article_attachments/48704526174483)
...
![The app asking you to grant access, with the Sign in with Google button](https://support.optisigns.com/hc/article_attachments/54322345172243)
...
![image](https://support.optisigns.com/hc/article_attachments/48704528589331)

You'll have to grant OptiSigns certain permissions in order to display your Private Google Slideshow:

![image](https://support.optisigns.com/hc/article_attachments/48704526181651)

If this is acceptable, hit **Continue**. Now you'll be back in OptiSigns, with additional options:

![The app authorized with Google, showing Aspect Ratio and Speed settings](https://support.optisigns.com/hc/article_attachments/54322345172755)
...
![The Aspect Ratio dropdown showing Default, 16:9 and 4:3](https://support.optisigns.com/hc/article_attachments/54322345173267)
...
![The Speed dropdown showing Slow, Medium, Fast and Custom](https://support.optisigns.com/hc/article_attachments/54322307468819)

#### Advanced Settings

Click **Advanced** to expand the field and provide an additional option:

![The Advanced section with the Force Sync Interval field](https://support.optisigns.com/hc/article_attachments/54322307469715)
...
![A screen row in the Screens list with the Edit button highlighted](https://support.optisigns.com/hc/article_attachments/54322307470739)

This brings up the **Edit Screen** menu:

![The Edit Screen window](https://support.optisigns.com/hc/article_attachments/54322307471379)

Here, select **Asset** under Content type.

![Selected Asset field with the Change button highlighted](https://support.optisigns.com/hc/article_attachments/54322307472019)
...
![The Playlists sidebar with the Create Playlist button highlighted](https://support.optisigns.com/hc/article_attachments/54322345180307)

Add your Google Slides asset to the Playlist:

![The right-hand asset panel filtered to Google Slides assets](https://support.optisigns.com/hc/article_attachments/54322345180563)

Here, you'll want to adjust the time it plays for by clicking the column in the items table:

![Playlist items with the per-item duration in seconds highlighted](https://support.optisigns.com/hc/article_attachments/54322307473171)
