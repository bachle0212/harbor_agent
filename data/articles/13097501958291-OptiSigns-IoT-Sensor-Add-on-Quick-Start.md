...
![The Add Connection dialog: Name, COM port, Baud rate, Data bits, Stop bits, Parity and encoding fields.](https://support.optisigns.com/hc/article_attachments/55404728356499)
...
| --- |
| **NOTE** |
| You can find your COM Port by navigating to the **Trigger Event Viewer**page on your screen and clicking on "Show":  ![The player's Trigger Event Viewer showing Sensor port: COM3 - not open, above the Send Command row.](https://support.optisigns.com/hc/article_attachments/42985157368979) |
