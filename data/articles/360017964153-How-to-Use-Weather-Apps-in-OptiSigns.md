...
Updated: 2026-09-10T09:40:16Z
Labels: weather, weather preset, weather wall, weather app, Create Weather Wall, Weather Conditions, weather radar
...
![The Weather app preview set to Landscape 16:9](https://support.optisigns.com/hc/article_attachments/55251687009427)

**Portrait View:**

![The Weather app preview set to Portrait 9:16, showing a vertical day list](https://support.optisigns.com/hc/article_attachments/55251710450451)

**Custom Orientation:**

![The Weather app preview set to Custom, with editable aspect-ratio boxes](https://support.optisigns.com/hc/article_attachments/55251687013011)

### Let’s set up your Weather Wall App

Navigate to the **Files/Assets** section and choose **Apps**, select the **Weather** app.

![Files/Assets and Apps highlighted, with the Weather app card selected in the Add App dialog](https://support.optisigns.com/hc/article_attachments/55251687014163)

Fill in all the required information for your Weather Wall on the left side:

![The Weather app configuration form: Name, Location, Language, Theme and three collapsed sections](https://support.optisigns.com/hc/article_attachments/55251687016083)
...
![The Units and Format section: Font Size, Date and time, Scale, Wind speed, Visibility and Rain](https://support.optisigns.com/hc/article_attachments/55251687016979)
...
![The Theme dropdown open, listing City Themes, Pacific Blue, Pearl Flaxen and seven more](https://support.optisigns.com/hc/article_attachments/55251687018259)
...
![The Theme options section with the Apply to all weather conditions toggle switched on](https://support.optisigns.com/hc/article_attachments/55251710468243)
...
![The Weather condition tabs: Clear, Clouds, Rain, Thunderstorm, Snow, Atmosphere, Smoke, Dust, Tornado](https://support.optisigns.com/hc/article_attachments/55251710469267)
...
![The Background Image setting, set to Default](https://support.optisigns.com/hc/article_attachments/55251710471955)
...
![Colour fields for text and background, each with a hex value, above a Reset button](https://support.optisigns.com/hc/article_attachments/55251687025683)

Click **Reset**to return to default settings.

**Advanced:**

![The Advanced section: Scrolling strip font size, Scrolling Strip Background and Lock location](https://support.optisigns.com/hc/article_attachments/55251687027859)
...
![The rendered weather preview: a sun icon, the temperature, and daily forecast icons](https://support.optisigns.com/hc/article_attachments/55251687028627)

### ![Cold weather icon: a pale blue sun and snowflake badge](https://support.optisigns.com/hc/article_attachments/40206389648147)

**Cold Weather -** This icon displays if the temperature is <=58°F

### ![Mild weather icon: a yellow and magenta sun and snowflake badge](https://support.optisigns.com/hc/article_attachments/40206380453011)

**Mild Weather -** This icon displays if the temperature is between 59°F and 85°F.

### ![Hot weather icon: an orange sun and snowflake badge](https://support.optisigns.com/hc/article_attachments/40206380453651)
